                ...
                <div class="bottom-sheet-tab-content" data-content="about" style="display: none;">
                    <div style="padding: 1.5rem; text-align: center;">
                        <div style="display: flex; justify-content: center; align-items: center; gap: 1rem; margin-bottom: 1.5rem;">
                            <img src="img/logo_gob.png" alt="Gobierno de México" style="height: 50px;">
                            <img src="img/logo_sener.png" alt="SENER" style="height: 50px;">
                        </div>
                        <h3 style="margin: 0 0 0.5rem 0; color: var(--color-gobmx-guinda); font-size: 1.1rem;">Resultados de la <span style="font-weight: bold;">PRIMERA CONVOCATORIA</span></h3>
                        <p style="margin: 0 0 1rem 0; color: #666; font-size: 0.9rem;">Permisos de Generación Eléctrica e Interconexión al SEN</p>
